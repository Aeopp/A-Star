...
BOOL CMainFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
	...
	m_tMainSplitter.CreateView(0, 1, RUNTIME_CLASS(CMFCToolView), CSize(1280, 720), pContext);
// 	m_tMainSplitter.CreateView(1, 0, RUNTIME_CLASS(CMyForm), CSize(300, 300), pContext);
// 	m_tMainSplitter.CreateView(1, 1, RUNTIME_CLASS(CMyForm), CSize(300, 300), pContext);
